...
public class Recipe {
    ...
    public Recipe(Long id, String name, String description, String instructions, List<RecipeIngredient> ingredients,
            Integer servings, Integer preparationTime, User creator, GoalType recommendedFor, Double caloriesPerServing,
            Double proteinPerServing, Double fatPerServing, Double carbsPerServing) {
        this.id = id;
        this.name = name;
