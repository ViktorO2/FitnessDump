...
public class RecipeDTO {
    ...
    public RecipeDTO(Long id, String name, String description, String instructions,
            List<RecipeIngredientDTO> ingredients, Integer servings, Integer preparationTime, Long creatorId,
            GoalType recommendedFor, Double caloriesPerServing, Double proteinPerServing, Double fatPerServing,
