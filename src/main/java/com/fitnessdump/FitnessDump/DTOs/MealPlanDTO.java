...
public class MealPlanDTO {
    ...
    public MealPlanDTO(Long id, Long userId, String name, String description, LocalDate startDate, LocalDate endDate, GoalType goal, Double targetCalories, Double targetProtein, Double targetFats, Double targetCarbs, List<MealPlanDayDTO> days) {
        this.id = id;
        this.userId = userId;
        this.name = name;
